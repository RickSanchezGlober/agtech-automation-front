...
#    And Se visualiza Botón Volver en la pantalla Empty State
  ...
  Scenario:  Productor - Listado de órdenes - Verifico listado de órdenes recientes
    ...
    Then Se muestra un listado de 10 órdenes
    And Se muestra Nombre del productor de las 10 órdenes
    And Se muestra Número de orden de las 10 órdenes
    And Se muestra Fecha y hora de generación de las 10 órdenes
    And Se muestra Descripción de las 10 órdenes
