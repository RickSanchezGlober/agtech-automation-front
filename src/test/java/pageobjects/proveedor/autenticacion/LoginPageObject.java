package pageobjects.proveedor.autenticacion;

import org.openqa.selenium.By;

public class LoginPageObject {

    public static final By.ByClassName NERA_LOGO = new By.ByClassName("header__container__logo");
    public static final By.ByClassName MENSAJE_BIENVENIDA_TEXT = new By.ByClassName("home__first_section__title");
    ...
    public static final By.ByCssSelector CERRAR_SESION_BUTTON = new By.ByCssSelector("li.profile_item__container:nth-child(2) > div:nth-child(1)");
